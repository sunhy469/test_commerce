...
function dashboardModuleLabel(key) { return ({overview:'总览扩展',orders:'订单管理',products:'商品管理',contentlive:'内容与直播',affiliate:'联盟带货',logistics:'物流履约',finance:'财务结算',health:'店铺健康',messages:'客户消息',settings:'设置'})[key] || key; }
