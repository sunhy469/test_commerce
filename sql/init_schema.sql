...
CREATE TABLE IF NOT EXISTS products_my (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    product_id TEXT UNIQUE,
    product_name TEXT,
    image_url TEXT,
...
CREATE TABLE IF NOT EXISTS products_ph (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    product_id TEXT UNIQUE,
    product_name TEXT,
    image_url TEXT,
...
CREATE TABLE IF NOT EXISTS products_sg (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    product_id TEXT UNIQUE,
    product_name TEXT,
    image_url TEXT,
...
CREATE TABLE IF NOT EXISTS products_th (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    product_id TEXT UNIQUE,
    product_name TEXT,
    image_url TEXT,
...
CREATE TABLE IF NOT EXISTS products_vn (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    product_id TEXT UNIQUE,
    product_name TEXT,
    image_url TEXT,
